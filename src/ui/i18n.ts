...
export const I18N: Record<string, Record<string, string>> = {
  "zh-CN": {
    ...
    referenceAdded: "文献已添加",
    bibtexImported: "已导入 {count} 条文献",
    referenceDeleted: "文献已删除",
    citationInserted: "引用已插入",
    citationsUpdated: "已更新 {count} 个引用",
    bibSlideGenerated: "参考文献页已生成",
    chartInserted: "图表已插入画布",
    chartDeleted: "图表已删除",
    chartDeleteConfirm: "确定删除这个图表吗？",
    subfigureInserted: "Subfigure 已插入画布",
    subfigureUpdated: "Subfigure 已更新",
    subfigureDeleted: "Subfigure 已删除",
    subfigureDeleteConfirm: "确定删除这个 Subfigure 吗？",
    subfigureNumberingApplied: "已更新 {count} 个 Subfigure 的编号",
    subfigureSelectedEmpty: "当前未选中 Subfigure。",
    slideTemplateInserted: "Slide 模板已插入画布",
    speakerCueSaved: "时间标注已保存",
    autoEstimateComplete: "已自动估算 {count} 张 slide 的时间",
    cuesCleared: "已清空全部时间标注",
    timeBudgetGenerated: "时间预算页已生成",
    appendixDividerInserted: "Appendix 分隔页已插入",
    backupLinkInserted: "Backup 链接已插入当前 slide",
    backLinkInserted: "Back 链接已插入当前 slide",
    appendixLinksUpdated: "已更新 {count} 个 Appendix 链接",
    appendixReordered: "Appendix 页面已重新排序",
  ...
  "en-US": {
    ...
    bibtexImported: "Imported {count} references",
    referenceDeleted: "Reference deleted",
    citationInserted: "Citation inserted",
    citationsUpdated: "Updated {count} citations",
    bibSlideGenerated: "Bibliography slide generated",
    chartInserted: "Chart inserted on the canvas",
    chartDeleted: "Chart deleted",
    chartDeleteConfirm: "Delete this chart?",
    subfigureInserted: "Subfigure inserted on the canvas",
    subfigureUpdated: "Subfigure updated",
    subfigureDeleted: "Subfigure deleted",
    subfigureDeleteConfirm: "Delete this Subfigure?",
    subfigureNumberingApplied: "Updated numbering for {count} Subfigures",
    subfigureSelectedEmpty: "No Subfigure selected.",
    slideTemplateInserted: "Slide template inserted on the canvas",
    speakerCueSaved: "Speaker cue saved",
    autoEstimateComplete: "Auto-estimated duration for {count} slides",
    cuesCleared: "All speaker cues cleared",
    timeBudgetGenerated: "Time budget slide generated",
    appendixDividerInserted: "Appendix divider inserted",
    backupLinkInserted: "Backup link inserted on current slide",
    backLinkInserted: "Back link inserted on current slide",
    appendixLinksUpdated: "Updated {count} appendix links",
    appendixReordered: "Appendix pages reordered",
